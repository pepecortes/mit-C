...
{
	struct student* pstuda=(struct student*)a;
	struct student* pstudb=(struct student*)b;
	char *ca = pstuda->fname;
	char *cb = pstudb->fname;
	return strcmp(ca, cb);
}
...
int compare_last_name(const void* a,const void* b)
{
	struct student* pstuda=(struct student*)a;
	struct student* pstudb=(struct student*)b;
	char *ca = pstuda->lname;
	char *cb = pstudb->lname;
	return strcmp(ca, cb);
}
